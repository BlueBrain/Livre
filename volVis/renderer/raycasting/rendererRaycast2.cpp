...
//    _dumpDebug( *texture, glewGetContext());
    ...
    float g = 0.f;
    float b = 0.f;
/*    if( renderNode.rank < 20 )
    {
        r = 1.f;
        g = ((float)renderNode.rank-8.f) / (20.f-8.f);
    }else
    {
        r = (32.f-(float)renderNode.rank) / (32.f-20.f);
        g = 1.f;
    }
*/
    if( renderNode.rank < 20 )
    {
        b = ((float)renderNode.rank-8.f) / (20.f-8.f);
        r = 1.f-b;
    }else
    {
        b = (32.f-(float)renderNode.rank) / (32.f-20.f);
        g = 1.f - b;
    }
