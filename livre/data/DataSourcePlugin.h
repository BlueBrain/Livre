...
{
public:
    LIVREDATA_API DataSourcePlugin();
     ...
     * )
     */
    LIVREDATA_API virtual LODNode internalNodeToLODNode(
     ...
     */
    LIVREDATA_API virtual bool update() { return false; }
    /**
 ...
 */
LIVREDATA_API bool fillRegularVolumeInfo(VolumeInformation& info);
}
...
template class LIVREDATA_API lunchbox::PluginFactory<
    livre::DataSourcePlugin, livre::DataSourcePluginData>;
#endif
