...
struct Pipeline::Impl
{
    ...
    void add(const std::string& name, Pipeline::UniqueExecutablePtr executable,
             bool wait)
    {
        ...
        if (wait)
        {
            ...
            _outFutures.insert(_outFutures.end(), futures.begin(),
                               futures.end());
        }
    ...
    Futures getPostconditions() const { return _outFutures; }
...
void Pipeline::_add(const std::string& name, UniqueExecutablePtr exec,
                    bool wait)
{
