...
if(FLATINDEX_FOUND)
  set(FLATIndex_name FLATINDEX)
  set(FLATIndex_FOUND TRUE)
elseif(FLATIndex_FOUND)
  set(FLATIndex_name FLATIndex)
  set(FLATINDEX_FOUND TRUE)
endif()
if(FLATIndex_name)
  list(APPEND FIND_PACKAGES_DEFINES LIVRE_USE_FLATINDEX)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND LIVRE_DEPENDENT_LIBRARIES FLATIndex)
  endif()
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} FLATIndex")
  link_directories(${${FLATIndex_name}_LIBRARY_DIRS})
  if(NOT "${${FLATIndex_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${FLATIndex_name}_INCLUDE_DIRS})
  endif()
  if(NOT "${${FLATIndex_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${FLATIndex_name}_INCLUDE_DIR})
  endif()
endif()
...
if(FlatBuffers_name)
  ...
  if(NOT "${${FlatBuffers_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${FlatBuffers_name}_INCLUDE_DIR})
  endif()
endif()

if(RESTCONNECTOR_FOUND)
  set(RESTConnector_name RESTCONNECTOR)
  set(RESTConnector_FOUND TRUE)
elseif(RESTConnector_FOUND)
  set(RESTConnector_name RESTConnector)
  set(RESTCONNECTOR_FOUND TRUE)
endif()
if(RESTConnector_name)
  list(APPEND FIND_PACKAGES_DEFINES LIVRE_USE_RESTCONNECTOR)
  if(NOT COMMON_LIBRARY_TYPE MATCHES "SHARED")
    list(APPEND LIVRE_DEPENDENT_LIBRARIES RESTConnector)
  endif()
  set(FIND_PACKAGES_FOUND "${FIND_PACKAGES_FOUND} RESTConnector")
  link_directories(${${RESTConnector_name}_LIBRARY_DIRS})
  if(NOT "${${RESTConnector_name}_INCLUDE_DIRS}" MATCHES "-NOTFOUND")
    include_directories(${${RESTConnector_name}_INCLUDE_DIRS})
  endif()
  if(NOT "${${RESTConnector_name}_INCLUDE_DIR}" MATCHES "-NOTFOUND")
    include_directories(${${RESTConnector_name}_INCLUDE_DIR})
  endif()
endif()
...
set(LIVRE_DEPENDS BBPTestData;FLATIndex;OpenMP;Tuvok;VTune;zeq;FlatBuffers;RESTConnector;LibJpegTurbo;Boost;Collage;dash;Equalizer;Lunchbox;OpenGL;PNG;Qt4;Threads)
