...
if(PKG_CONFIG_EXECUTABLE)
  ...
  if((NOT Boost_FOUND) AND (NOT BOOST_FOUND))
    message(FATAL_ERROR "Could not find Boost COMPONENTS date_time")
  endif()
else()
...
if(PKG_CONFIG_EXECUTABLE)
  find_package(Equalizer 1.7)
  if((NOT Equalizer_FOUND) AND (NOT EQUALIZER_FOUND))
    pkg_check_modules(Equalizer Equalizer>=1.7)
  endif()
  if((NOT Equalizer_FOUND) AND (NOT EQUALIZER_FOUND))
...
if(CBLAS_name)
  list(APPEND FIND_PACKAGES_DEFINES LIVRE_USE_CBLAS)
